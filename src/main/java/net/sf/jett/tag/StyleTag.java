...
public class StyleTag extends BaseTag
{
    ...
    private void examineAndApplyStyle(Workbook workbook, Cell cell)
    {
        ...
        boolean fontBoldweight = (myStyle.getFontBold() != null) ? myStyle.getFontBold() : f.getBold();
        int fontCharset = (myStyle.getFontCharset() != null) ? myStyle.getFontCharset().ordinal() : f.getCharSet();
        ...
        byte fontUnderline = (myStyle.getFontUnderline() != null) ? (byte)myStyle.getFontUnderline().ordinal() : f.getUnderline();
