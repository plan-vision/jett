...
public class AttributeUtil
{
                                       ...
                                       String text, Map<String, Object> beans, String attrName, Class<T> expectedClass, T def)
    {
        ...
        else if (obj instanceof String)
        {
            ...
            catch (SecurityException | NoSuchMethodException | InvocationTargetException | IllegalArgumentException  | InstantiationException | IllegalAccessException | ClassCastException e)
            {
                throw attributeValidationFailure(tag, text, "Expected a \"" + expectedClass.getName() + "\" for \"" +
