...
public class StyleTagTest extends TestCase
{
   ...
   protected void check(Workbook workbook)
   {
      ...
      assertEquals(BorderStyle.MEDIUM_DASH_DOT_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 1).getBorderBottom());
      assertEquals(BorderStyle.MEDIUM_DASH_DOT_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 1).getBorderLeft());
      assertEquals(BorderStyle.MEDIUM_DASH_DOT_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 1).getBorderRight());
      assertEquals(BorderStyle.MEDIUM_DASH_DOT_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 1).getBorderTop());
      assertEquals(BorderStyle.MEDIUM_DASH_DOT_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 3).getBorderBottom());
      assertEquals(BorderStyle.MEDIUM_DASH_DOT_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 5).getBorderLeft());
      assertEquals(BorderStyle.MEDIUM_DASH_DOT_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 7).getBorderRight());
      assertEquals(BorderStyle.MEDIUM_DASH_DOT_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 9).getBorderTop());
      ...
      List<FontCharset> charsets = new ArrayList<FontCharset>();
      ...
      for (int r = 0; r < hssfColors.size(); r++)
      {
         ...
         for (int c = 0; c < charsets.size(); c++)
         {
            ...
            assertEquals(charsets.get(c), f.getCharSet());
         }
      }
   ...
   protected Map<String, Object> getBeansMap()
   {
      ...
      for (BorderStyle borderType : BorderStyle.values())
